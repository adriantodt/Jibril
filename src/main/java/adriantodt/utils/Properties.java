...
public class Properties extends ConcurrentHashMap<String, String> {
    ...
    private void _store(BufferedWriter bw, String comments, boolean escUnicode) throws IOException {
        ...
        bw.newLine();
        synchronized (this) {
            Set<Entry<String, String>> entries = new TreeSet<>(Comparator.comparing(Entry::getKey));
    ...
    public void loadFromString(String content) throws IOException {
        _load(new LineReader(new StringReader(content)));
    }
    ...
    public String saveToString(String comments) throws IOException {
