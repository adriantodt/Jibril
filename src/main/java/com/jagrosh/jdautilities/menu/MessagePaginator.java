...
public class MessagePaginator extends Menu {
    ...
    public static class Builder extends Menu.Builder<Builder, MessagePaginator> {
         ...
         *
         * @param allowTextInput {@code true} if the MessagePaginator will allow page-number text input
         * @return This builder
         */
         ...
         *
         * @param embedFunction The BiFunction that uses both current and total page numbers to get embed for the Message
         * @return This builder
         */
         ...
         *
         * @param finalAction The Consumer action to perform if the MessagePaginator times out
         * @return This builder
         */
         ...
         *
         * @param messageFunction The BiFunction that uses both current and total page numbers to get the Message
         * @return This builder
         */
         ...
         *
         * @param left  The left text input, causes the MessagePaginator to traverse one page left
         * @param right The right text input, causes the MessagePaginator to traverse one page right
         * @return This builder
         */
         ...
         *
         * @param wait {@code true} if the MessagePaginator will still generate
         * @return This builder
         */
