...
class Invite : ICommand, ICommand.HelpDialogProvider {
    ...
    override fun call(event: GuildMessageReceivedEvent, args: String) {
        embed {
            ...
            field("Want me around on your Server?", "https://is.gd/aru")
            field("Need support? Join my Server!", "https://is.gd/aruhub")
            field("Wanna support a poor angel?", "https://patreon.com/arubot")
