...
class Resume(musicManager: MusicManager) : MusicPermissionCommand(musicManager, "voteresume"), ICommand.HelpDialogProvider {
    ...
    override val helpHandler = Help(
        CommandDescription(listOf("resume"), "Resume Command", thumbnail = "https://assets.aru.pw/img/category/music.png"),
        Description(
            "Resumes the player",
            "",
...
class VoteResume(musicManager: MusicManager) : MusicVotingCommand(musicManager), ICommand.HelpDialogProvider {
    ...
    override val helpHandler = Help(
        CommandDescription(listOf("voteresume"), "VoteResume Command", thumbnail = "https://assets.aru.pw/img/category/music.png"),
        Description(
